...
/**
 * Stock loss caused by theft (internal/external), administrative errors, damage, or spoilage, which reduces inventory value.
 ...
 */
public class LossOperationTypeProcessor extends AdjustmentOperationTypeProcessor {
	
	public LossOperationTypeProcessor(StockOperationType stockOperationType) {
