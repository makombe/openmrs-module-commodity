...
public interface StockManagementService extends OpenmrsService {
	...
	@Transactional(readOnly = true)
	@Authorized(value = { Privileges.APP_STOCKMANAGEMENT_STOCKOPERATIONS,
			Privileges.APP_STOCKMANAGEMENT_STOCKITEMS }, requireAll = false)
	...
	void sendStockOperationNotification(String stockOperationUuid, StockOperationAction.Action action,
			String actionReason,
	...
	void getStockInventoryExpiryForecastData(StockItemInventorySearchFilter filter,
	...
	@Transactional(readOnly = true)
	Map<Integer, Boolean> checkStockBatchHasTransactionsAfterOperation(Integer stockOperationId,
	...
	List<StockItemReference> getStockItemReferenceByStockItem(String uuid);
	 ...
	 Map<Integer, StockItemSummaryDTO> getAggregatedStockItemSummaries(
